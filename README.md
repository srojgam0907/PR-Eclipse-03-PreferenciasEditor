...
![matching brackets](capturas/01_general.png)
...
![save actions](capturas/02_saveActions(1).png)

*Despues de guardar*

![save actions](capturas/02_saveActions(2).png)
...
![content assist](capturas/03_contentAssist.png)
...
![syntax coloring](capturas/04_syntaxColoring.png)
...
![mark occurrences](capturas/05_markOccurrences.png)
